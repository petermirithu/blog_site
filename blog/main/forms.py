...
class blogForm(FlaskForm):
  ...
  '''
  category=SelectField(u'Enter Category of blog', choices =[('Lifestyle Blog','Lifestyle Blogs'),('Entertainment Blogs','Entertainment Blogs'),('Education Blogs','Education Blogs'),('Political Blogs','Political Blogs'),('Relationship Blogs','Relationship Blogs')])
